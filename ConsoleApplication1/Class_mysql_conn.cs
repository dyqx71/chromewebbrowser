...
namespace ConsoleApplication1
{
    public class Class_mysql_conn
    {
        ...
        public static string ConnStr = "Server=112.74.86.173;Port=3306;Stmt=;Database=cms; User=root;Password=root;";
        ...
        //运行存储过程
        public static void Run_Pro(string cmdText, string Connstr, MySqlParameter[] param)
        {
            MySqlConnection Conn = Open_Conn(ConnStr);
            MySqlCommand Cmd = Create_Cmd(cmdText, Conn);
